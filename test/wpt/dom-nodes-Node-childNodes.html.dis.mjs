...
var check_parent_node = function(node) {
  ...
  // console.log(node.childNodes.length, node.firstChild.nodeName, Array.from(node.childNodes.list()).map(x=>x.nodeName))
...
test(function() {
  ...
  assert_equals(list[Symbol.iterator], Array.prototype[Symbol.iterator], {skip:true});
  assert_equals(list.keys, Array.prototype.keys, {skip:true});
  if (Array.prototype.values) {
    assert_equals(list.values, Array.prototype.values, {skip:true});
  }
  assert_equals(list.entries, Array.prototype.entries, {skip:true});
  assert_equals(list.forEach, Array.prototype.forEach, {skip:true});
